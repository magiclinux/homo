...
def draw_plot(rectified_flow, z0, z1, N=None):
  ...
  plt.tight_layout()
  plt.savefig('123_spiral_output.pdf', format='pdf', bbox_inches='tight') # Should change
...
draw_plot(rectified_flow_2, z0=initial_model.sample([300]), z1=target_model.sample([300]).detach().clone())
