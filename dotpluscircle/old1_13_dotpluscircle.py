...
def draw_plot(rectified_flow, z0, z1, N=None):
  ...
  plt.tight_layout()
  plt.savefig('../figures/2_13_dotpluscircle_output.pdf', format='pdf', bbox_inches='tight') # Should change
...
# 从 π_1（螺旋分布）采样 600 个点
samples_1 = spiral_model.sample([600])
draw_plot(rectified_flow_1, z0=samples_0, z1=samples_1.detach().clone())
