...
def draw_plot(rectified_flow, z0, z1, N=None):
  ...
  plt.title('Transfer result in spin dataset', fontsize=13)
  plt.tight_layout()
  plt.savefig('../figures/3_123_2round_spiral_output.pdf', format='pdf', bbox_inches='tight') # Should change
