...
def draw_plot(rectified_flow, z0, z1, N=None):
  ...
  plt.tight_layout()
  plt.savefig('figures/3_13_2round_spiral_output.pdf', format='pdf', bbox_inches='tight') # Should change
...
draw_plot(rectified_flow_1, z0=initial_model.sample([600]), z1=target_model.sample([600]).detach().clone())
