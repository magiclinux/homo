...
def draw_plot(rectified_flow, z0, z1, N=None):
  ...
  plt.title('Transfer result in four-mode dataset', fontsize=13)
  plt.tight_layout()
  # plt.savefig('figures/3_3_2round_spiral_output.pdf', format='pdf', bbox_inches='tight') # Should change
...
draw_plot(rectified_flow_2, z0=initial_model.sample([400]), z1=target_model.sample([400]).detach().clone())
