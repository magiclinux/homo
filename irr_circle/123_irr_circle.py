...
plt.tight_layout()
plt.savefig('center_to_irregular_ring_dataset.pdf', format='pdf', bbox_inches='tight')
plt.show()
...
def draw_plot(rectified_flow, z0, z1, N=None):
  ...
  plt.title('Transfer result in irregular ring dataset', fontsize=12)
  plt.tight_layout()
  plt.savefig('123_irr_circle_output.pdf', format='pdf', bbox_inches='tight') # Should change
