...
def draw_plot(rectified_flow, z0, z1, N=None):
  ...
  plt.tight_layout()
  # plt.savefig('8_12_output.pdf', format='pdf', bbox_inches='tight') # Should change
...
z_t, t, first_order_gt, second_order_gt = rectified_flow_1.get_train_tuple(z0=z0, z1=z1)
