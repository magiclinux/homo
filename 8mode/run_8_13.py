...
class RectifiedFlow1(nn.Module):
...
def draw_plot(rectified_flow, z0, z1, N=None):
  ...
  plt.tight_layout()
  # plt.savefig('8_13_output.pdf', format='pdf', bbox_inches='tight') # Should change
...
draw_plot(rectified_flow_1, z0=z0, z1=z1)
z_t, t, first_order_gt = rectified_flow_1.get_train_tuple(z0=z0, z1=z1)
d = torch.zeros_like(t)
thop_input = (z_t, t, d)
flops, params = profile(rectified_flow_1, thop_input)
