...
class RectifiedFlow(nn.Module):
  ...
  def forward(self, z_t=None, t=None):
...
def draw_plot(rectified_flow, z0, z1, N=None):
  ...
  plt.tight_layout()
  # plt.savefig('8_1_output.pdf', format='pdf', bbox_inches='tight') # Should change
...
z_t, t, first_order_gt = rectified_flow_2.get_train_tuple(z0=z0, z1=z1)
