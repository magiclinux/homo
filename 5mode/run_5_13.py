...
def draw_plot(rectified_flow, z0, z1, N=None):
  ...
  plt.tight_layout()
  plt.savefig('5_13_output.pdf', format='pdf', bbox_inches='tight') # Should change
...
draw_plot(rectified_flow_1, z0=initial_model.sample([500]), z1=target_model.sample([500]).detach().clone())
