...
def draw_plot(rectified_flow, z0, z1, N=None):
  ...
  plt.tight_layout()
  # plt.savefig('../figures/2_13_3round_spiral_output.pdf', format='pdf', bbox_inches='tight') # Should change
...
rectified_flow_1 = RectifiedFlow1(model, num_steps=128)
# import copy
...
draw_plot(rectified_flow_1, z0=initial_model.sample([900]), z1=target_model.sample([900]).detach().clone())
